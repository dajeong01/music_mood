...
function Home() {
  ...
  useEffect(() => {
    ...
    class Particle {
      ...
      draw() {
        ...
        if (this.currentWeather === "rainy") {
          ...
          ctx.lineTo(this.x + this.directionX, this.y + this.directionY * 3);
    ...
    const init = () => {
      ...
      switch (weather) {
        case "rainy":
          numberOfParticles = (canvas.height * canvas.width) / 4000;
          break;
        case "snowy":
      ...
      for (let i = 0; i < numberOfParticles; i++) {
        ...
        switch (weather) {
          case "rainy":
            ...
            directionX = 0.5;
            directionY = Math.random() * 2 + 5;
            color = "rgba(174, 229, 255, 0.6)";
            break;
          case "snowy":
  ...
  return (
    <div css={s.globalStyles}>
      <div css={s.weatherControls}>
        <button css={s.weatherBtn(weather === "sunny")} onClick={() => setWeather("sunny")}>
          ☀️
        </button>
        <button css={s.weatherBtn(weather === "rainy")} onClick={() => setWeather("rainy")}>
          🌧️
        </button>
        <button css={s.weatherBtn(weather === "snowy")} onClick={() => setWeather("snowy")}>
          ❄️
        </button>
      </div>
